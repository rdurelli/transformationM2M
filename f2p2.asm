...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="A.__matchPerson2Aspect():V"/>
		<constant value="A.__matchname():V"/>
		<constant value="__exec__"/>
		<constant value="Person2Aspect"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyPerson2Aspect(NTransientLink;):V"/>
		<constant value="A.__applyname(NTransientLink;):V"/>
		<constant value="__matchPerson2Aspect"/>
		...
		<constant value="__applyPerson2Aspect"/>
	...
	<operation name="75">
		...
		<localvariabletable>
			<lve slot="3" name="73" begin="7" end="9"/>
			<lve slot="2" name="72" begin="3" end="9"/>
			<lve slot="0" name="17" begin="0" end="9"/>
			<lve slot="1" name="70" begin="0" end="9"/>
		</localvariabletable>
	</operation>
</asm>
